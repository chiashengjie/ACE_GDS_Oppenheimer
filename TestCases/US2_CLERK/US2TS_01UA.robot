...
*** Test Cases ***
User Story Clerk (2) - TS 01 UNHAPPY A
    [documentation]    Insert Random Number of Records via insertRandomToDatabaseForNoReason API - Count 0 (FAIL)
...
### Test for Multiple Single Hero Details via insertRandomToDatabaseForNoReason: Set Count to 0 to check if there are any possible errors
    Insert Multiple Random Hero Details via API    0
