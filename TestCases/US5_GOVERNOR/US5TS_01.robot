...
User Story Governor (5) - TS 01
    [documentation]   Check for Dispense Now Button and make sure the spelling is spelled correctly
...
### Test if the Dispense Now Button is Spelled Correctly
    Element Text Should be    ${DISPENSENOWBUTTON}    Dispense Now
