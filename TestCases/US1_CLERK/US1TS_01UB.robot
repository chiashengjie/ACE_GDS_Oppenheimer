...
*** Test Cases ***
User Story Clerk (1) - TS 01 UNHAPPY B
    [documentation]    Insert Single Record via insert insertPerson API - Missing NAME (FAIL)
...
### Test for Insert Complete Single Hero Details
    Insert Hero Details via Insert API    ${HeroDetailsEdgeCases[0]}    ${EMPTY}    ${HeroDetailsEdgeCases[2]}    ${HeroDetailsEdgeCases[3]}    ${HeroDetailsEdgeCases[4]}    ${HeroDetailsEdgeCases[5]}
