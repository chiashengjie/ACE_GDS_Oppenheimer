...
*** Test Cases ***
User Story Clerk (1) - TS 01 UNHAPPY F
    [documentation]    Insert Single Record via insert insertPerson API - Missing TAX (FAIL)
...
### Test for Insert Complete Single Hero Details
    Insert Hero Details via Insert API    ${HeroDetailsEdgeCases[0]}    ${HeroDetailsEdgeCases[1]}    ${HeroDetailsEdgeCases[2]}    ${HeroDetailsEdgeCases[3]}    ${HeroDetailsEdgeCases[4]}    ${EMPTY}
