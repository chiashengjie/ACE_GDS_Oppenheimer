...
*** Test Cases ***
User Story Clerk (1) - TS 01 UNHAPPY C
    [documentation]    Insert Single Record via insert insertPerson API - Missing GENDER (FAIL)
...
### Test for Insert Complete Single Hero Details
    Insert Hero Details via Insert API    ${HeroDetailsEdgeCases[0]}    ${HeroDetailsEdgeCases[1]}    ${EMPTY}    ${HeroDetailsEdgeCases[3]}    ${HeroDetailsEdgeCases[4]}    ${HeroDetailsEdgeCases[5]}
